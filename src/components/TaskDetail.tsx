            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-800 rounded-xl p-4 border border-gray-700/50">
                ...
                <input
                  ...
                  className="w-full text-base font-semibold bg-transparent border-none text-white focus:outline-none focus:ring-0 placeholder-gray-500 mb-3"
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full text-sm bg-transparent border-none text-gray-300 focus:outline-none focus:ring-0 resize-none placeholder-gray-500"
                ...
                {task.subtasks && task.subtasks.length > 0 && (
                  <div className="mt-4 pt-4 border-t border-gray-700/50">
                    <h4 className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-3">Subtasks</h4>
